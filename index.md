...
|-----|-------|--------|-------|----------|
| [0000-connection-adapter-fidelity](rfcs/0000-connection-adapter-fidelity/README.md) | Connection-adapter fidelity — converge connection_adapters/ onto the Rails tree | draft | @deanmarano | activerecord |
