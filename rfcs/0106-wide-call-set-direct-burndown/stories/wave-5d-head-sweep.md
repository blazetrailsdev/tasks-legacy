...
The 6-7 row band (41 rows):

    activerecord/relation.json                                7
    activerecord/connection-adapters/abstract-adapter.json    7
    activerecord/connection-adapters/abstract/transaction.json 7
    activerecord/connection-adapters/mysql/schema-dumper.json 7
    activerecord/relation/calculations.json                   7
    activerecord/relation/delegation.json                     6
