---
title: "strip-freeform-comments-ar-connection-adapters"
status: claimed
updated: 2026-08-23
...
priority: null
pr: null
claim: "2026-08-23T20:39:07Z"
assignee: "strip-freeform-comments-ar-connection-adapters"
blocked-by: null
closed-reason: null
---
...
- [ ] `packages/activerecord/src/connection-adapters/**/*.ts` added to the `no-freeform-comments` block's `files` in
      `eslint.config.mjs`.
