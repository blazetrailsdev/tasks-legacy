---
title: "Converge visitors/mysql and visitors/sqlite assertion parity"
status: ready
updated: 2026-08-24
...
RFC 0122's per-file burndown. Rails file(s): `visitors/mysql_test.rb, visitors/sqlite_test.rb`
(under `vendor/rails/activerecord/test/cases/arel/`). trails file(s): `packages/arel/src/visitors/mysql.test.ts, packages/arel/src/visitors/sqlite.test.ts`.
...
Two small adapter-visitor files, same `must_be_like` class.
