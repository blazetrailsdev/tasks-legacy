---
title: "acquire_connection owns the blocking queue wait, as connection_pool.rb:1006 does"
status: draft
updated: 2026-08-13
...
now follows Rails' guard clause after PR #6464:
    ...
    # activerecord/lib/active_record/connection_adapters/abstract/connection_pool.rb:551
...
(connection_pool.rb:1006), whose job is exactly "return a connection, blocking on
...
one-line delegation connection_pool.rb:551 is. Reconcile or rename the existing
...
- [ ] `_acquireConnection(checkoutTimeout)` owns the queue wait and the timeout
      raise, mirroring connection_pool.rb:1006.
