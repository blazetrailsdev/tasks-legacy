...
| ----------------------------------------- | --------------------------------------------- |
| `mysql/schema-creation.test.ts` (361 L)   | `mysql/schema-creation.trails.test.ts` (31 L) |
...
- [ ] `mysql/schema-creation.test.ts` is merged into `mysql/schema-creation.trails.test.ts` and deleted,
