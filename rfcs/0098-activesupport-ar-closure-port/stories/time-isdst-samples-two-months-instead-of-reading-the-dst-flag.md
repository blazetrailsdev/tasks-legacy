...
assignee: null
blocked-by: null
closed-reason: 'Superseded and delivered by vendor-a-tzdata-isdst-table-so-the-three-dst-readings-stop-sampling-two-months (trails#6949), the re-scope the blocker itself prescribed (''Only option 3 remains -- vendoring a generated tzdata isdst table''). On origin/main packages/date/src/tzdata-isdst.ts vendors the bit (generated by scripts/generate-tzdata-isdst.ts, with a regeneration guard); time.ts:1008-1010 Time#isdst and time.ts:200-204 tzdataAbbreviation both call tzdataIsdst(), and activesupport/src/values/time-zone.ts:652-653 Timezone#isDst does too. ''git grep -n "month: 7, day: 1" origin/main -- packages/'' returns nothing: the January/July sampling this story is about no longer exists at any of the three sites.'
---
